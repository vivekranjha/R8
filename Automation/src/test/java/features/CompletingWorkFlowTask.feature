Feature:  Completing Workflow Task
...
Scenario: Logout the LSCP application
When User should be able to logut the applicaton

Scenario: Completing Workflow Task

	Given Login with Approver
